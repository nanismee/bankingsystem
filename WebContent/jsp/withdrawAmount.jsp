...
<head>
	...
	function checkValidation(){
		...
		if(ano==""){
			...
			document.getElementById('tdWithdrawAmount').innerHTML="Please Enter withdraw amount";
			...
			if(!flag){    
				document.getElementById('tdAccountNo').innerHTML="Only digits allowed";
            	 ...
            	 if(regx.test(amount) && amount>0){
            		 ...
            		 document.getElementById('tdWithdrawAmount').innerHTML="Please Enter valid amount";
            	 }            	 
             }
		}
		return false;
