...
<head>
	...
	<title>Quick Transaction | FIT Online Banking</title>
	...
	<div class="MainContainer">
           ...
           <div id="mainBody" class="MainBody" > 
           		...
           		<form action="" method="post">
           			...
           			<input type="button" id="showDetailsBtn" value="Show Transactions" style="padding:3px;width:120px;margin-left:3px;"/>
           		</form>
           		</div>
