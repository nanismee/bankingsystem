...
<head>
	...
	<title>Customer Home Page | FIT Online Bank</title>
	...
	function checkChangeUsernameValidation(){
		...
		if(oldUsername==""){
			$("#tdOldUsername").html("Please enter former username");
		}else if(newUsername==""){
			$("#tdNewUsername").html("Please enter new username");
		}else if(loginPassword==""){
			$("#tdLoginPassword").html("Please enter login password");
		}else if(confirmLoginPassword==""){
			$("#tdConfirmLoginPassword").html("Please enter confirm login password");
		}else{
			if(regx.test(newUsername)==true && regx.test(oldUsername)==true &&  oldUsername!=newUsername && loginPassword==confirmLoginPassword){
				...
				if(regx.test(oldUsername)==false){
					$("#tdOldUsername").html("Please enter a valid username");
				}else if(regx.test(newUsername)==false){
					$("#tdNewUsername").html("Please enter a valid username");
				}else if(oldUsername==newUsername){
					$("#tdNewUsername").html("Former & new username can't be same");
	...
	function checkChangeLoginPasswordValidation(){
		...
		if(currentUsername==""){
			$("#tdCurrentUsername").html("Please enter current username");
		}else if(oldPassword==""){
			$("#tdOldPassword").html("Please enter old password");
		}else if(newPassword==""){
			$("#tdNewPassword").html("Please enter new password");
		}else if(confirmPassword==""){
			$("#tdConfirmPassword").html("Please enter confirm password");
		}else{
			if(regx.test(currentUsername)==true && oldPassword!=newPassword && newPassword==confirmPassword){
				changeLoginPassword();
			}else{
				if(regx.test(currentUsername)==false){
					$("#tdCurrentUsername").html("Please enter a valid username");
				}else if(oldPassword==newPassword){
					$("#tdNewPassword").html("Former and new password can't be same");
        ...
        xmlhttp.onreadystatechange=function(){
            ...
            { 
            	...
            	if(xmlhttp.responseText==1){
                    ...
                    document.getElementById('message').innerHTML='Your have successfully changed your username.';
        ...
        xmlhttp.onreadystatechange=function(){
            ...
            { 
            	...
            	if(xmlhttp.responseText==1){
                    ...
                    document.getElementById('image-icon').style.backgroundImage='url(${path}/images/right-info.png)';
                    document.getElementById('display-message').style.borderColor='green';
                    document.getElementById('message').innerHTML='Your have successfully changed your login password.';
        ...
        xmlhttp.onreadystatechange=function(){
            ...
            { 
            	...
            	if(xmlhttp.responseText==1){
                    ...
                    document.getElementById('image-icon').style.backgroundImage='url(${path}/images/right-info.png)';
                    document.getElementById('display-message').style.borderColor='green';
                    document.getElementById('message').innerHTML='Your have successfully changed your transaction password.';
	...
	function createFundTransferContainer(){
		...
		function viewAccountDetails(){
			...
			$.getJSON("${path}/AccountDetails?accountNo="+${accountNo}, function(data) {
				document.getElementById('loadingContainer').style.display="none";
				if(data!=null){
					var image = '<%=pageContext.getSession().getAttribute("image") %>';
	   			...
	   			"<div id='rightContainer' class='RightContainer'>"+
	   				"<table class='AccountDetailsTable'>"+
	   				"<tr><td>Photograph</td><td><div id='photographContainer' class='PhotographContainer'><img alt='' src='data:image/jpg;base64,"+image+"' width='120px' height='130px' /></div></td></tr>"+
	...
	<div class="MainContainer">
           ...
           <div id="mainBody" class="MainBody" >
           		<div id="leftContainer" class="LeftContainer">
           			<h2 style="color:darkred">Welcome to FIT Online Bank</h2>
           			<div style="border-radius: 10px;height:300px;width:500px;background-size:500px 300px;background-image:url('${path}/images/online.jpg');"></div>
           		</div>
           		...
           		<div class="SideBarContainer">
                	<div class="QuickLinksBoard">
                        ...
                        <a href="${path }/index.jsp" style="color:green;font-size:14px;">Go to Home Page</a><br>
                        ...
                        <a href="${path }/jsp/sevices.jsp" style="color:green;font-size:14px;">About FIT Online Bank Services</a><br>
