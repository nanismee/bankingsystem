...
<html>
	...
	<title>Close Account | FIT Online Bank</title>
	...
	function checkAccountNo(){
		...
		if(accountNo!=""){
			if(regx.test(accountNo)){
				...
				$("#tdAccountNo").html("Please enter valid account number");
			}
		}else{
			$("#tdAccountNo").html("Please enter account number");
		}
	}
			...
			if(accountNo!=""){
				if(regx.test(accountNo)){
					if(accountNo.length==16){
						...
						$("#tdAccountNo").html("Account Number should be 16 digits");
					}
				}else{
		...
		<div class="MainBody">
			<form action="" method="post">
				...
				<div id="leftContainer" class="LeftContainer">
					...
					<input type="button" id='buttonId' value="Close"
